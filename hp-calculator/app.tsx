...
function App() {
  ...
  }, [state.courseId, state.stamina, state.guts, state.strategy, state.speed, state.healPercent]);
  ...
  }, [state.courseId, state.stamina, state.guts, state.speed, state.healPercent]);
  ...
  return (
    <>
      ...
      <main className="main">
          ...
          <div className="sidebar-section">
            ...
            <div className="sidebar-step">
              ...
              <div className="step-content">
                ...
                <p>Choose from common race courses or enter a custom course ID. Distance affects HP requirements.</p>
              </div>
            </div>
            ...
            <div className="sidebar-step">
              ...
              <div className="step-content">
                ...
                <p>Input your uma's Speed, Stamina, and Guts. These determine max HP and consumption rate.</p>
              </div>
            </div>
            ...
            <div className="sidebar-step">
              ...
              <div className="step-content">
                <h4>Set Heal %</h4>
                <p>Add total healing from skills (e.g., two gold heals = ~11%). This extends your effective HP.</p>
              </div>
            </div>
            ...
            <div className="sidebar-step">
              ...
              <div className="step-content">
                <h4>Check Results</h4>
                <p>See if you can full spurt. Green surplus = safe. The "Min Stamina" shows the threshold.</p>
              </div>
            </div>
          </div>
        </aside>
        ...
        <div className="content-area">
            ...
            <div className="form-group" style={{ marginBottom: 'var(--space-lg)' }}>
              ...
              <div className="select-wrapper">
                <select
                  ...
                  onChange={(e) => updateState({ courseId: (e.target as HTMLSelectElement).value })}
                >
                  ...
                  <option value="custom">Custom Course ID...</option>
                </select>
                <ChevronDown size={16} className="select-chevron" />
              </div>
              {!COMMON_COURSES.find((c) => c.id === state.courseId) && (
                <input
                  type="text"
                  ...
                  value={state.courseId}
                  onChange={(e) => updateState({ courseId: (e.target as HTMLInputElement).value })}
                />
              )}
            </div>
            ...
            <div className="stats-grid" style={{ marginBottom: 'var(--space-lg)' }}>
              <div className="stat-input-group">
                <label className="stat-label">
                  <img src={STAT_ICONS.speed} alt="" className="stat-icon" />
                  Speed
                </label>
                <input
                  type="number"
                  ...
                  max={2000}
                  onChange={(e) =>
                    updateState({ speed: parseInt((e.target as HTMLInputElement).value) || 1200 })
                  }
                />
              </div>
              ...
              <div className="stat-input-group">
                <label className="stat-label">
                  <img src={STAT_ICONS.stamina} alt="" className="stat-icon" />
                  Stamina
                </label>
                <input
                  type="number"
                  ...
                  max={2000}
                  onChange={(e) =>
                    updateState({ stamina: parseInt((e.target as HTMLInputElement).value) || 1200 })
                  }
                />
              </div>
              ...
              <div className="stat-input-group">
                ...
                <input
                  ...
                  max={2000}
                  onChange={(e) =>
                    updateState({ guts: parseInt((e.target as HTMLInputElement).value) || 1000 })
                  }
                />
              </div>
              ...
              <div className="stat-input-group">
                <label className="stat-label">
                  <img src={STAT_ICONS.wisdom} alt="" className="stat-icon" />
                  Wit
                </label>
                <input
                  type="number"
                  ...
                  max={2000}
                  onChange={(e) =>
                    updateState({ wisdom: parseInt((e.target as HTMLInputElement).value) || 1200 })
                  }
                />
              </div>
              ...
              <div className="stat-input-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateState({
                      healPercent: parseFloat((e.target as HTMLInputElement).value) || 0,
                    })
                  }
                />
              </div>
            ...
            <div className="form-group">
              ...
              <div className="select-wrapper">
                <select
                  ...
                  onChange={(e) =>
                    updateState({ strategy: (e.target as HTMLSelectElement).value as Strategy })
                  }
                >
            ...
            <div className="card results-card">
              ...
              <div className="results-grid">
                <div className="result-row">
                  ...
                  <span className="result-value mono">{estimate.maxHp.toLocaleString()}</span>
                </div>

                <div className="result-row">
                  <span className="result-label">Total Needed</span>
                  <span className="result-value mono">{estimate.totalHpNeeded.toLocaleString()}</span>
                </div>

                <div className="result-row">
                  <span className="result-label">Phase 0+1</span>
                  <span className="result-value">
                    <span className="mono">{estimate.phase01Hp.toLocaleString()}</span>
                ...
                <div className="result-row">
                  ...
                  <span className="result-value">
                    <span className="mono">{estimate.phase2Hp.toLocaleString()}</span>
                ...
                <div className="result-highlight">
                  ...
                  <div className={`spurt-indicator ${estimate.canFullSpurt ? 'success' : 'failure'}`}>
                ...
                <div className="min-stamina-row">
                  <span className="min-stamina-label">
                    ...
                    {state.healPercent > 0 && (
                      <span className="result-note"> (with {state.healPercent}% heal)</span>
                    )}
                  </span>
          ...
          <div className="comparison-section">
            ...
            <div className={`comparison-table-wrapper ${state.showComparison ? 'open' : ''}`}>
              <table className="comparison-table">
                ...
                <tbody>
                  {comparison.map(({ strategy, estimate: est }) => (
                    <tr
                      key={strategy}
                      className={strategy === state.strategy ? 'highlight-row' : ''}
                    >
                      ...
                      <td>{est?.minStaminaForFullSpurt.toLocaleString() ?? '-'}</td>
                      <td className={est?.canFullSpurt ? 'spurt-yes' : 'spurt-no'}>
                        {est?.canFullSpurt ? <Check size={16} /> : <X size={16} />}
                      </td>
                    </tr>
                  ))}
                </tbody>
        ...
        <aside className="sidebar">
          <div className="sidebar-tip">
            ...
            <p>Max HP depends on stamina, distance, and strategy coefficient.</p>
            <div className="sidebar-formula">
              MaxHP = 0.8 × Coef × Stam + Dist
            </div>
            <p style={{ marginTop: 'var(--space-sm)' }}>Guts reduces HP consumption during spurt phase.</p>
            <div className="sidebar-formula">
          ...
          <div className="sidebar-tip">
            ...
            <div className="sidebar-formula">
              Late Surger: 1.000 (best)<br/>
              End Closer: 0.995<br/>
              Front Runner: 0.950<br/>
              Pace Chaser: 0.890<br/>
              Runaway: 0.860
            </div>
          </div>
          ...
          <div className="sidebar-tip">
            ...
            <p>This calculator gives optimistic estimates. For safety in real races, add 5-10% buffer to the minimum stamina shown.</p>
          </div>
        </aside>
        </div>
      </main>
      ...
      <footer className="footer">
        <a href="https://github.com/namespaceciel/uma-tools" target="_blank" rel="noopener">
          Uma Tools
        </a>{' '}
        | HP Calculator
      </footer>
