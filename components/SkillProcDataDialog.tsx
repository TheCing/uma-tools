		...
		<>
			...
			<div class="skillProcDataDialog" ref={dialogRef} tabIndex={-1}>
				<div class="skillProcDataHeader">
					...
					<button class="skillProcDataClose" onClick={onClose}>x</button>
				</div>
				<div class="skillProcDataContent">
					<div style="margin-bottom: 8px; width: 300px;">
						...
						<div style="display: flex; width: 100%; height: 8px; border: 1px solid var(--border-color, #ccc); overflow: hidden; margin-bottom: 8px;">
